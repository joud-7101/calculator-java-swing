...
public final class Calculator extends javax.swing.JFrame {
    // --- Singleton Step 1: Create a private static instance ---
    // This holds the single object of Calculator; starts as null until first use.
    ...
    // Making constructor private prevents creating Calculator objects with "new"
    // from outside this class. Only this class controls object creation.
    ...
    // --- Singleton Step 3: Public static accessor method ---
    // This method provides the single global access point.
    // - On first call: creates the Calculator object.
    // - On later calls: returns the same object (no new creation).
    public static Calculator getInstance() {
        if (instance == null) {// create only once
            instance = new Calculator();
        }
        return instance;// always return the one instance
    }
